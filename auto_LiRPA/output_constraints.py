...
def backward_general_with_output_constraint(
    ...
    if not bound_node.has_gammas():
        return self.backward_general(
            bound_node=bound_node,
            C=C,
            start_backpropagation_at_node=start_backporpagation_at_node,
    ...
    # This is specific to the YOLO benchmark. "5" is also hardcoded in linear.py to create the gammas.
    num_constraints = 5 
