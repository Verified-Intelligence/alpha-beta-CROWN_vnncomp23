...
class Bound(nn.Module):
    ...
    def has_gammas(self):
        # This is the specific layer that should have output constraints in the YOLO benchmark
        return self.name == "/92"

    def init_gammas(self):
        if not self.has_gammas():
            return
        ...
        num_constraints = 5  # This is specific to the YOLO benchmark. Only that benchmark uses output constraints.
